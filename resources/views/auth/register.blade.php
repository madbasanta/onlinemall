...
@section('keywords', 'register,new account,register online mall,register onlinemall,account online mall,online mall,sign up onlinemall')
                    ...
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row mb-0">
                            <div class="col-md-6 offset-md-4">
                                <button type="submit" class="btn btn-info px-4 text-white btn-sm">
                                    {{ __('Register') }}
                                </button>
                            </div>
                        </div>
