<div class="modal-dialog">
	<div class="modal-content">
		<div class="modal-header bg-primary">
			<div class="modal-title pull-left">ORDER - ADD</div>
			<button type="button" class="close pull-right" data-dismiss="modal">&times;</button>
		</div>
		<div class="modal-body">
			<form action="/admin/inventory/order" data-id="{{ $inventory->id }}" id="inventoryOrderForm">
				@csrf
				<div class="row">
					<div class="col-md-12">
					...
					<div class="col-md-12" id="inventoryInformation">
						...
						<div class="row" data-row="1">
							...
							<div class="col-md-10">
								<div class="form-group">
									<select name="inventory_id[1]" id="invItem" class="form-control">
							...
							<div class="col-md-4">
								<div class="form-group">
									<input type="number" name="qty[1]" id="invQty" class="form-control">
								</div>
							</div>
						</div>
					</div>
